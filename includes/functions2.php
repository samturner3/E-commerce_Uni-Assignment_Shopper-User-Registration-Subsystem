...
function login($email, $password, $mysqli) {
    ...
    if ($stmt = $mysqli->prepare("SELECT members.userid, members.email, members.username, members.fname, members.lname, members.sClass, members_password.password, members_password.salt, members_addresses.hname, members_addresses.hcity, members_addresses.hstate, members_addresses.hcode
									from members
        ...
        $stmt->bind_result($user_id, $email, $username, $fname, $lname, $sClass, $db_password, $salt, $hname, $hcity, $hstate, $hcode);
        $stmt->fetch();
