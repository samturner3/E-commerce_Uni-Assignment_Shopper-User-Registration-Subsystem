...
?>
    ...
    <?php if (login_check($conn) == true) {
            ...
            <ul class="reset menu hover">
                <li><a href="/mqauth/43156711/NewStar/food_only.php">Food Items</a></li>
                <li><a href="/mqauth/43156711/NewStar/uniform_only.php">All Uniform Items</a></li>
                <li><a href="#">Tops</a></li>
            ...
            <ul class="reset menu hover">
                ...
                <li><a href="/mqauth/43156711/NewStar/includes/logout.php">Log Off</a></li>
            </ul>
               <?php } 
			   else {
				   ?>
				<ul class="reset menu hover">
                <li><a href="/mqauth/43156711/NewStar/index.php">Log On</a></li>
